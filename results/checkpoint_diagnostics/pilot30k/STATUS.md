...
**Status: INFRASTRUCTURE READY — GPU JOBS NOT YET SUBMITTED**
...
| infrastructure commit | *(filled in at commit time)* |
...
|---|---|---|---|
| surface-form | `train/submit_eval_pilot30k_surface.pbs` | *(pending)* | NOT SUBMITTED |
| adverse framing | `train/submit_eval_pilot30k_framing.pbs` | *(pending)* | NOT SUBMITTED |

## Observed row counts

*(filled in after the jobs complete)*

## Completion status

**NOT COMPLETE — GPU jobs not yet submitted.**
